                     ...
                     <div class="row">
                        <div class="col">
                           <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="name" placeholder="Fullname" class="form-control">
                           </div>
                        </div>
                           <div class="col">
                              <div class="mb-3">
                        ...
                        <div class="col">
                           <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="address" placeholder="St. Address, Barangay, City, Country " class="form-control" required>
                           </div>
                        </div>
                           <div class="col">
                              <div class="mb-3">
                        ...
                        <div class="text-center mt-3">
                           <h6>Have an account? <a class="text-decoration-none" href="user_login.php">Login now</a></h6><br>
